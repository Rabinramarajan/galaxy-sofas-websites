      ...
      <article className="flex h-full flex-col">
        <Link href={href} className="group block">
          <div className="relative aspect-[4/5] overflow-hidden bg-linen">
            ...
            <div className="absolute inset-x-0 bottom-0 hidden p-4 opacity-0 transition-opacity duration-300 group-hover:opacity-100 md:block">
              <span className="inline-flex min-h-11 items-center gap-2 bg-parchment/95 px-4 text-[10px] uppercase tracking-[0.18em] text-charcoal">
                View details
        ...
        <div className="flex flex-1 flex-col pt-4">
          ...
          <div className="mt-auto pt-4">
            <Button href={href} variant="secondary" className="group min-h-11 px-4 text-[10px]">
              View Details
              <span className="transition-transform duration-300 group-hover:translate-x-1">
                <IconArrow />
              </span>
